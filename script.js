...
gsap.to("#page>video", {
    ...
    /**
     * Callback function that starts video playback when the scroll trigger animation begins.
     * This function is executed when the GSAP ScrollTrigger animation starts, automatically
     * playing the video element located within the #page container.
     */
    onStart: () => {
...
// Ensure Locomotive Scroll updates on resize
